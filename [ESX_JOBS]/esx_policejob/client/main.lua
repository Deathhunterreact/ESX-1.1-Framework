...
function OpenCloakroomMenu()
	...
	if grade == 'const' then
		table.insert(elements, {label = _U('police_wear'), value = 'const_wear'})
	elseif grade == 'hc' then
		table.insert(elements, {label = _U('police_wear'), value = 'hc_wear'})
	elseif grade == 'si' then
		table.insert(elements, {label = _U('police_wear'), value = 'si_wear'})
	elseif grade == 'inspector' then
		table.insert(elements, {label = _U('police_wear'), value = 'inspector_wear'})
	elseif grade == 'dsp' then
		table.insert(elements, {label = _U('police_wear'), value = 'dsp_wear'})
	elseif grade == 'ssp' then
		table.insert(elements, {label = _U('police_wear'), value = 'ssp_wear'})
	elseif grade == 'dig' then
		table.insert(elements, {label = _U('police_wear'), value = 'dig_wear'})
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if
			data.current.value == 'const_wear' or
			data.current.value == 'hc_wear' or
			data.current.value == 'si_wear' or
			data.current.value == 'inspector_wear' or
			data.current.value == 'dsp_wear' or
			data.current.value == 'ssp_wear' or
			data.current.value == 'dig_wear' or
